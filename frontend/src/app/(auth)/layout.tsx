  ...
  return (
    <div className="min-h-screen flex justify-center items-center relative overflow-hidden bg-[#0f1729]">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute top-[55%] right-[55%] w-4 h-4 text-[#F39C12] opacity-35 animate-float" style={{animationDelay: '3.1s'}}>
          <svg fill="currentColor" viewBox="0 0 24 24" className="drop-shadow-lg">
      ...
      <div className="w-full max-w-md mx-4 relative z-10">
        ...
        <div className="bg-[#1e293b] backdrop-blur-xl rounded-3xl shadow-2xl border border-[#334155] p-10 relative overflow-hidden">
          {/* Card subtle glow */}
          <div className="absolute inset-0 bg-gradient-to-br from-[#1e293b] via-[#1e293b] to-[#334155]/50 rounded-3xl"></div>
          ...
          <div className="absolute top-4 right-4 w-8 h-8 bg-gradient-to-br from-[#F39C12]/40 to-[#F39C12]/20 rounded-full opacity-60 animate-pulse"></div>
          <div className="absolute bottom-4 left-4 w-6 h-6 bg-gradient-to-br from-[#F39C12]/30 to-[#e08e0b]/20 rounded-full opacity-50 animate-pulse" style={{animationDelay: '1s'}}></div>
        </div>
      </div>
    </div>
  );
